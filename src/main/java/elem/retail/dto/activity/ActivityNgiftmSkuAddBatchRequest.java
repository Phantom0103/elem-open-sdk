...
@Getter
@Setter
public class ActivityNgiftmSkuAddBatchRequest extends BaseElemRequest {

    private static final long serialVersionUID = -2542421514013390874L;
    ...
    public String getCmd() {
        return "activity.ngiftm.sku.add.batch";
    }
