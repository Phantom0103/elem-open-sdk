...
@Getter
@Setter
public class ActNitemDiscountSkuUpdateBatchRequest extends BaseElemRequest {

    private static final long serialVersionUID = -8716848448189108941L;
    ...
    public String getCmd() {
        return "act.nitemdiscount.sku.update.batch";
    }
