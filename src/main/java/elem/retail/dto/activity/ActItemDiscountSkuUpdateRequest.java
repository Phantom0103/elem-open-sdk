...
@Getter
@Setter
public class ActItemDiscountSkuUpdateRequest extends BaseElemRequest {

    private static final long serialVersionUID = -7005730966388783794L;
    ...
    public String getCmd() {
        return "act.itemdiscount.sku.update";
    }
