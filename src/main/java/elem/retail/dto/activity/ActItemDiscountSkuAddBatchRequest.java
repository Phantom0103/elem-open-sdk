...
@Getter
@Setter
public class ActItemDiscountSkuAddBatchRequest extends BaseElemRequest {

    private static final long serialVersionUID = 7985519803140383413L;
    ...
    public String getCmd() {
        return "act.itemdiscount.sku.add.batch";
    }
